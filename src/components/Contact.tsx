    ...
    <section className={styles.contact} id="contact" aria-label="Contact">
      <div className="container">
        <motion.div
          ...
          animate={animate}
        >
          <motion.p className={`sectionLabel ${styles.label}`} variants={revealVariants}>
            Get In Touch
          </motion.p>

          <motion.h2 className={styles.heading} variants={revealVariants}>
            Let's build something.
          </motion.h2>

          <motion.p className={styles.sub} variants={revealVariants}>
            Open to full-time roles, freelance engagements, and interesting problems.
          </motion.p>

          <motion.div className={styles.actions} variants={revealVariants}>
